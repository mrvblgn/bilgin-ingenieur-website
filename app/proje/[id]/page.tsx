...
export default function ProjectDetailPage() {
  ...
  const projectTitle = project ? t(`projects.project${project.id}.title`) : '';
  const projectDescription = project ? t(`projects.project${project.id}.description`) : '';
        ...
        >
          ...
          >
            <Image
              ...
              alt={`${projectTitle} - Bild ${currentImageIndex + 1}`}
              fill
